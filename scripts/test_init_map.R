...
sourceCpp("~/Documents/Research/clustering_spatialMeans/src/test_init_map.cpp")
sourceCpp("~/Documents/Research/clustering_spatialMeans/src/map_cluster.cpp")

test_init <- test_init_map(Y, W, a1 = a1, a2 = a2, nu_sigma = nu_sigma, lambda_sigma = lambda_sigma, rho = 0.9)
test_map <- map_partition(Y, W, a1= a1, a2 = a2, nu_sigma = nu_sigma, lambda_sigma = lambda_sigma, rho = 0.9)
