                              ...
                              const double split_frac = 0.1)
{
  ...
  while((iter < max_iter) & (flag == 0)){
    ...
    for(int l = 0; l < L; l++){
      ...
      // Spectral Splits
      get_spectral_split(spec_si, particle_set[l], T, A_block, rho, a1, a2, 1000);
      delete spec_split_candidate;
      spec_split_candidate = new Partition(particle_set[l]);
      best_split(spec_si, spec_split_candidate, l, particle_set, w, ybar, T, A_block, rho, a1, a2, nu_sigma, lambda_sigma, eta, lambda, true);
      ...
      best_split(tail_si, tail_split_candidate, l, particle_set, w, ybar, T, A_block, rho, a1, a2, nu_sigma, lambda_sigma, eta, lambda, true);
      ...
      // KM splits
      get_km_split(km_si, particle_set[l], T, A_block, rho, a1, a2, 2500);
      delete km_split_candidate;
      km_split_candidate = new Partition(particle_set[l]);
      best_split(km_si, km_split_candidate, l, particle_set, w, ybar, T, A_block, rho, a1, a2, nu_sigma, lambda_sigma, eta, lambda, true);
      ...
      best_split(bi, border_candidate, l, particle_set, w, ybar, T, A_block, rho, a1, a2, nu_sigma, lambda_sigma, eta, lambda, false);
      ...
      best_split(isl_i, island_candidate, l, particle_set, w, ybar, T, A_block, rho, a1, a2, nu_sigma, lambda_sigma, eta, lambda, false);
